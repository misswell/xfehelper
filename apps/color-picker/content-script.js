/**
 * XFeHelper Page Color Picker Tools
 */

window.colorpickerContentScript = function () {


    let XFeHelper = window.XFeHelper || {};
     ...
     * 页面取色器
     */
    XFeHelper.ColorPicker = (function () {
        ...
        function setPixelPreview(pix, hxe, lhex) {
            ...
            if (!_ge('fehelper-colorpicker-cpimprev') || (rgb && !_ge('cprgbvl'))) {
                emptyNode(n);
                XFeHelper.elemTool.elm('div', {}, [
                    XFeHelper.elemTool.elm('img', {
                    ...
                    XFeHelper.elemTool.elm('br'),
                    XFeHelper.elemTool.elm('input', {
                        type: 'text',
                        size: 7,
        ...
        function setDisplay() {//XFeHelper.elemTool.elm
            emptyNode(n);
            XFeHelper.elemTool.elm('div', {}, [
                XFeHelper.elemTool.elm('input', {
                    type: 'text',
